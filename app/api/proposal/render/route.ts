...
import { renderPhotoreal, renderAvailable } from "@/lib/proposal/ai-render";
...
/** AI 렌더 가능 여부(키 설정) — 클라이언트 auto-run 판단용. */
...
export async function POST(req: Request) {
  ...
  const result = await renderPhotoreal(parsed.data.imageBase64, {
